            ...
            <div className="p-4 ">
                ...
                <div className="page-header">
                    <div className="row align-items-center">
                        <div className="col">
                            <h3 className="page-title">Recruiters</h3>
                        ...
                        <div className="col-auto float-right ml-auto">
                            <Link
                                ...
                                to="/dashboard/recruiters/add"
                            >
                                <i className="fa fa-plus"></i> Add Recruiter
                            </Link>
                                                    ...
                                                    >
                                                        <div className="profile-widget shadow">
                                                            <div className="profile-img">
                                                                <Link
                                                                    to={`/dashboard/recruiters/view/${item.id}`}
                                                                    className="avatar"
                                                                >
                                                                    <img
                                                                        src={
